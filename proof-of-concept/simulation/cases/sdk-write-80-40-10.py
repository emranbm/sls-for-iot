...
try:
    ...
    exp.get_node(devices[0]).sendCmd("node write-by-sdk.js 0.8") # 80% chance of write on each step
    exp.get_node(devices[1]).sendCmd("node write-by-sdk.js 0.4") # 40% chance of write on each step
    exp.get_node(devices[2]).sendCmd("node write-by-sdk.js 0.1") # 10% chance of write on each step
